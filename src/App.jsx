...
import NoProjectSlected from "./components/NoProjectSelected";
...
function App() {
  ...
  if(projectsState.selectedProjectId === null){
    ...
    content = <NoProjectSlected onStartAddProject= {handleStartAddProject} />
  }

  return (
    <main className="flex flex-row h-screen gap-8">
